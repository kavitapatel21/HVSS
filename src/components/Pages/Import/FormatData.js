        ...
        <div className="common-layout">
            ...
            <div className="table-wrapper">
                <table>
                    <thead>
                        <tr>
                            <th className="text-center">Code Position</th>
                    ...
                    {data.map((rowData, rowIndex) => (
                      <tr key={rowIndex}>
                        {rowData.map((cellData, cellIndex) => (
                          <td className="text-center" key={cellIndex}>{cellData}</td>
                        ))}
                      </tr>
                    ))}
                    </tbody>
            ...
            <div className="text-end mt-4">
              <button onClick="" className="primary-button ms-auto">Save</button>
            </div>
        </div>
    </div>
      </div>
